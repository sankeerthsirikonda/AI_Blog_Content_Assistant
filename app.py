...
if submit_topic: # Handle button click (submit_topic)
    ...
    title_suggestion_output = title_suggestion_chain.invoke({"topic": topic_name})
    title_suggestion_str = title_suggestion_output.content
...
if submit_title: # Handle button click for submitting information
    ...
    blog_text=title_chain.invoke({'title': title_of_the_blog, 'keywords': formatted_keywords, 'blog_length':num_of_words}) # Generate and display the blog content using the title chain
    st.write(blog_text.content)
